    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row gap-x-10'>
        ...
        className='flex flex-1 flex-col gap-y-12 mb-10 lg:mb-0'>
         ...
         <a href='https://netflixclone-web31.netlify.app'><div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
            <div className='group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300'></div>
            <img className='group-hover:scale-125 transition-all duration-500 w-[600px] h-[350px]' src={Project1} />
            <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
            <span className='text-gradient'>Netflix clone</span>
              <p className='text-xl text-white'>Embark on a cinematic journey with Movie Hub, an impressive Netflix clone developed using ReactJS, Axios, and seamlessly integrated with The Movie Database (TMDb) API. Immerse yourself in a visually stunning and user-friendly environment that allows you to explore a vast collection of movies and TV shows, complete with embedded YouTube trailers for an enhanced viewing experience.</p>
            </div>
          </div></a> 
        </motion.div>
